...
const routes = [
  ...
  },
  {
    ...
    component: () => import("@/views/resource/images/index"),
    name: "ResourceImages",
    meta: {
      title: "title.resourceImages",
      keepAlive: true,
    },
  },
  {
  ...
  {
    path: "/topicDemo/topic/index",
    component: ()=>import("@/views/topic-demo/topic/index"),
    name: "TopicDemoTopic",
    meta: {
      title: "title.topic-demo-topic-title",
    },
  },
  {
    path: "/topicDemo/topic/create",
    component: ()=>import("@/views/topic-demo/topic/create"),
    name: "TopicDemoTopicCreate",
    meta: {
